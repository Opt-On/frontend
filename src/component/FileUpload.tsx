...
export default function FileUpload() {
  ...
  const renderFooter = () => (
    <Box sx={{ pb: 3, px: 3, display: 'flex', justifyContent: 'flex-end', gap: 2 }}>
  ...
  return (
    <>
        ...
        {isOpen && (
            <Dialog 
                title={<Text sx={{ fontSize: 18, fontWeight: 'bold' }}>Import course history</Text>} 
            ...
            >   
                ...
                >
                    ...
                    <input
                        ...
                        id="file-upload"
                    />
                    <Button leadingVisual={FileDirectoryIcon} style={{ fontWeight: 600, margin: "auto" }} as="label" htmlFor="file-upload">
                        Browse Files
                    </Button>
                ...
                {file && (
                    <Box mt={3}>
                        <Text as="p"><strong>Uploaded File:</strong> {file.name}</Text>
                    </Box>
                )}
            </Dialog>
        )}
